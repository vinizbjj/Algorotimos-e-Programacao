...
int main()
{
    ...
    if (kg <= 5)
    {
        printf("Menos de 5kg vai ser pago R$%.2f no Morango e R$%.2f na Maca\n", 2.50 * morango, 1.80 * maca);
    }
    else if (kg > 5 && kg <= 8)
    {
        printf("Mais de 5kg e menos de 8kg vai ser pago R$%.2f no Morango e R$%.2f na Maca\n", 2.20 * morango, 1.50 * maca);
    }
